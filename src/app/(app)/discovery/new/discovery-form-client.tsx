...
export function DiscoveryFormClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const criteria_json = {
      ...
      ownership_types: f.ownership_triggers.filter(o => (OWNERSHIP_TYPES as readonly string[]).includes(o)),
      strategic_triggers: f.ownership_triggers.filter(o => (STRATEGIC_TRIGGERS as readonly string[]).includes(o)),
